  ...
  defp init(:meta) do
    ...
    SmartGlobal.new(
      ...
      %{
        ...
        aexn_template_creation_event_hash: [{[], :aec_hash.blake2b_256_hash("TemplateCreation")}],
        aexn_template_deletion_event_hash: [{[], :aec_hash.blake2b_256_hash("TemplateDeletion")}],
        aexn_template_mint_event_hash: [{[], :aec_hash.blake2b_256_hash("TemplateMint")}],

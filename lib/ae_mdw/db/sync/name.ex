defmodule AeMdw.Db.Sync.Name do
  ...
  def expire_auction(state, height, plain_name) do
    ...
    m_name_owner_exp = Model.owner_expiration(index: {owner, expire, plain_name})
    ...
    |> cache_through_write(Model.ActiveNameOwnerExpiration, m_name_owner_exp)
  ...
  defp cache_through_delete_active(
    ...
    |> cache_through_delete(Model.ActiveNameOwnerExpiration, {owner_pk, expiration, plain_name})
  end
  ...
  def deactivate_name(
    ...
    m_owner_expiration = Model.owner_expiration(index: {owner_pk, deactivate_height, plain_name})
    ...
    |> cache_through_write(Model.InactiveNameOwnerExpiration, m_owner_expiration)
  end

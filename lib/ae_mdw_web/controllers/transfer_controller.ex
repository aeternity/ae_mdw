defmodule AeMdwWeb.TransferController do
  ...
  def convert({"account", [account_id]}), do: [account_pk: Validate.id!(account_id, [:account_pubkey])]
  ...
  def transfers_search_context!([account_pk: target_pk, kind_prefix: kind_prefix], start, scope_checker, limit) do

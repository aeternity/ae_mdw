defmodule AeMdw.Node.ContractCallFixtures do
  ...
  def call_rec(
    ...
    {:call,
     <<217, 192, 160, 215, 73, 228, 214, 92, 129, 165, 176, 2, 41, 205, 99, 175, 18, 216, 41, 107,
       163, 78, 242, 13, 215, 35, 109, 151, 189, 181, 5, 109>>,
     {:id, :account,
      <<153, 64, 204, 182, 107, 235, 121, 143, 104, 151, 33, 210, 195, 98, 97, 157, 242, 61, 71,
        15, 20, 161, 53, 252, 108, 108, 172, 202, 182, 45, 35, 129>>}, 851, 633_129,
     {:id, :contract,
      <<46, 45, 66, 42, 171, 23, 186, 153, 167, 41, 204, 175, 3, 32, 136, 142, 172, 72, 29, 171,
        231, 25, 168, 179, 135, 26, 13, 47, 67, 25, 57, 155>>}, 1_000_000_000, 88_847,
     <<59, 111, 135, 106, 148, 215, 79, 66, 255, 192, 111, 136, 27, 193, 109, 103, 78, 199, 255,
       192, 111, 136, 3, 102, 59, 203, 87, 244, 146, 201>>, :ok,
     [
       {remote_pk1,
        [
